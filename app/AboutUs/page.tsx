import ContentTextBlock from "../Components/ContentBlock"
      ...
      <section className={styles.hero}>
        <div className={styles.heroContent}>
          ...
          <ImageWithCaption
            ...
            caption="Voluntários da ONG AnimalPontoCom cuidam de cães e gatos em abrigo residencial adaptado."
            figureClass={styles.figure}
            imageClass={styles.figureImg}
            captionClass="figure-caption"
          />
