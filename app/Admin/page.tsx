...
const adminSections = [
  ...
  {
    label: "Receber formulario de Parceiro e cadastrar/editar pessoa",
    ...
    <main className={styles.page}>
      <section className={styles.hero}>
        <div className={styles.heroCopy}>
          ...
          <p>
            Aqui ficam as areas administrativas do sistema, organizadas para acesso rapido
            a cadastros, formularios, gestao e acompanhamento das entidades principais da ONG.
          </p>
        </div>
        ...
        <div className={styles.cardGrid}>
          {adminSections.map((section, index) => (
            <article key={`${section.label}-${index}`} className={styles.card}>
              ...
              <h3>{section.label}</h3>
              <p>
                Acesso para visualizar, cadastrar, editar e acompanhar registros ligados a
                este modulo.
              </p>
